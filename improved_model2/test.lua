...
if opt.agentPath ~= '' then
    ...
    agent = torch.load("./detector2/trained_agent_6000.t7")
end
...
function demo()
    ...
    for i = 1, #valSet do
        ...
        for j = 1, #rnn_output do
            ...
            local c3d, _, _ = dh:getSingleTrimedByName(vidName, pred[j])
...
function test_net()
    ...
    for i = 1, #valSet do
        ...
        local pred_set = {}
        for j = 1, #rnn_output do
            local seg_pred = _clip_segments(rnn_output[j]):resize(2)
